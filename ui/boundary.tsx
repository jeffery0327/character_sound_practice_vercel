...
type Color = 'colorful' | 'gray' | 'pink' | 'blue' | 'violet' | 'cyan' | 'orange' | 'red';
  ...
  return (
    <div
      className={clsx('relative border', {
        ...
        'border-secondary': color === 'colorful',
    ...
    >
      ...
      <div
        className={clsx(className, {
          ...
          'pl-3 pr-3 pb-3 pt-9 lg:p-9': size === 'medium',
        })}
      >
        {children}
      </div>
...
const Label = ({
  ...
  return (
    <div
      className={clsx(
        'px-1.5 font-mono leading-4 font-medium tracking-widest uppercase ring-1 ring-gray-950',
        {
          ...
          'bg-bg text-text-main': color === 'colorful',
